...
app.controller('contentController' ,function($scope,$http,contentService){
	...
	$scope.resultMap={keywords:[],'withCredentials':true}
	$scope.search1 = function(){
		$http.post('http://10.10.84.102:8060/search',$scope.resultMap).success(
		function (response) {
			location.href='http://10.10.84.102:8060/search.html';
		}
		);
	}
	$scope.contentList=[];
